  ...
  return (
    <section id="contact">
      <div className="section-container">
        ...
        <h2 className="section-title text-white">Me Contacter</h2>
          ...
          <form className="space-y-6 animate-fade-up">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full px-4 py-3 rounded-lg border border-[#0AFFFF]/30 bg-[#1A1F2C]/80 text-white focus:outline-none focus:ring-2 focus:ring-[#0AFFFF]/50 focus:border-[#0AFFFF] transition-colors"
